...
In this solution we have used a **simple single-agent DDPG (Deep Deterministic Policy Gradient)** agent implemented using a simple feed-forward network in Pytorch. More details are provided in [project report](PROJECT_REPORT.md) along with the weights for our trained agent. 
